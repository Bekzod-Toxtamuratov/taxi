  ...
  "node_modules/vue-yandex-maps/dist/vue-yandex-maps.esm.js"(exports) {
    ...
    function n(e2) {
      return new Promise((t2, n2) => {
        if (window.ymaps) return o.ymapReady || (o.ymapReady = true, o.$emit("scriptIsLoaded")), t2(true);
        if (document.getElementById("vue-yandex-maps-script")) return void o.$on("scriptIsLoaded", t2);
